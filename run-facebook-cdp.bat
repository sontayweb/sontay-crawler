...
powershell -Command "$t = Get-Date -Format 'yyyyMMdd_HHmmss'; npm run scrape -- --source='facebook-cdp' --out=\"data/exports/facebook_leads_$t.csv\" | Tee-Object -FilePath \"data/exports/facebook_leads_$t.log\""
